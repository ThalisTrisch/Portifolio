...
import Netflix from "/PrintCloneNetflix.png"
    ...
    return(
        <>
            <div className="flex justify-center w-full flex-wrap">
                ...
                <div className="flex flex-row w-full justify-center flex-wrap mb-10 gap-6 items-center">
                    <div className="w-80">
                ...
                <div className="flex flex-row w-full justify-center flex-wrap-reverse mb-12 gap-6 items-center ">
                    <div className='w-2/4 h-fit bg-zinc-200 max-md:w-80 rounded-xl px-6 py-6'>
                        <p className="text-2xl max-md:text-xl mb-2 text-justify max-md:text-center">
                            <strong>Clone Netflix</strong>
                        </p>
                        <p className="text-md max-md:text-sm text-justify"> 
                            Projeto criando o clone da interface da Netflix para o meu aperfeiçoamento em criação de layouts e paginas com melhor design. 
                        </p>
                        <div className="flex flex-row gap-2 mt-4 flex-wrap">
                            <Tech tech="TaiwindCSS"></Tech>
                            <Tech tech="ReactJS"></Tech>
                            <Tech tech="typescript"></Tech>
                        </div>
                    </div>
