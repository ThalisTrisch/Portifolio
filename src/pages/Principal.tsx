    ...
    <div className=' bg-white/100'>
      ...
      <div className='w-full flex  justify-center mb-12'>
        <div className='w-2/3 max-md:w-3/4'>
          <p className='text-justify text-sm'>&#160; &#160; &#160; &#160; &#160;Atualmente com 20 anos estou cursando análise e desenvolvimento de 
          ...
          tecnologia almejando atuar futuramente como full stack em desenvolvimento web.
          </p>
        </div>
      </div>
      <Footer></Footer>
